...
describe("ServiceContainer", () => {
  ...
  it("should create and return a service instance", () => {
    const logsService = container.get(
    ...
    const logsService2 = container.get(
      NewRelicLogsService as unknown as Constructor<NewRelicLogsService>,
    );
  ...
  it("should register and retrieve a service instance", () => {
    ...
    container.register(
      TestService as Constructor<typeof mockService>,
      mockService,
    );

    const retrievedService = container.get(
      TestService as Constructor<typeof mockService>,
    );
  ...
  it("should check if a service is registered", () => {
    ...
    expect(container.has(TestService as Constructor<typeof mockService>)).toBe(
      false,
    );
  ...
  it("should clear all registered services", () => {
    ...
    const newLogsService = container.get(
      NewRelicLogsService as unknown as Constructor<NewRelicLogsService>,
    );
